...
/>
      ...
      <section className="px-6 md:px-16 py-20 grid md:grid-cols-2 gap-10 items-center bg-[#111111]">
        <div className="space-y-6">
          ...
          <p className="text-lg text-[#C1C1C1]">
            Discover an extraordinary online shopping experience with our collection
            that spans from local designers to leading international brands,
            featuring a captivating array of clothing and industrial materials.
          </p>
          <p className="text-[#00B3A3] font-medium text-xl">For Business Inquiries</p>
        </div>
      ...
      <section className="bg-black px-6 md:px-16 py-16 w-full">
        <h2 className="text-white text-4xl font-bold mb-8 text-center">Explore Our Products</h2>
