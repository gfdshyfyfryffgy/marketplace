...
const faqData = [
  ...
  },
  {
    ...
    answer: "Visit our website or contact our team for the most recent pricing information.",
  },
  {
    question: "How often are the pipe product prices updated?",
    answer: "Prices are updated daily based on market conditions and availability.",
  },
  {
    question: "Are different sizes and thicknesses available?",
    answer: "Yes, we offer pipes in a wide range of diameters, thicknesses, and pressure ratings.",
  },
  {
    question: "Can I request custom lengths or bulk orders for pipes?",
    answer: "Absolutely, we support bulk and custom length orders for all pipe types.",
  },
  {
    question: "What factors should be considered when buying pipes?",
    answer: "Material type, application, pressure rating, size, and compliance with standards should be considered.",
  },
];
